...
<form action="AddExpense" method="get">
        ...
        <div id="abc1">
            ...
            <div id="abc3">
                ...
                <input type="text" placeholder="--Category--" list="drop" name="category">
                      <datalist id="drop">
                    ...
                    <option value="Hom Maintainance">HomeMaintainance</option>
                ...
                <br>
                <textarea name="description" id="textarea" cols="26" rows="5" placeholder="Description " style="border-radius: 30px;"></textarea>
                <br>
